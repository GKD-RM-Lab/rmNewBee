...
{ 
    ...
    while(true)
    {   
        std::cout <<"1.add_robot 2.add_task 3.delete_task 4.task_done 5.delete_robot 6.indicate_tasks 7.list_robot 8.exit" <<endl;
        ...
        case 2://add_tasks
        {
            ...
            if (robot) {
                ...
                cout <<"Priority:";
                cin >>priority;
                robot->add_task(ID, desc,priority);
            } else {
        ...
        {   
            ...
            if(robot)
        {
            list1.find_robot(name)->indicate_task();
        }
        else{
            cout <<"Robot not found" <<endl;
        }
